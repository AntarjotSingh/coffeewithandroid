package com.coffeewithandroid.mediaplayernotification
...
class MediaPlayerService : MediaBrowserServiceCompat(), MediaPlayer.OnPreparedListener {
    ...
    fun startInForeGround() {
        val notificaton = createNotification()
        val mgr = NotificationManagerCompat.from(this)
        mgr.cancelAll()
        mgr.notify(NOTIFICATION_ID, notificaton)
    }
    ...
    companion object {
        ...
        const val PODCAST_URL = "http://791353.youcanlearnit.net/EC_podcast.mp3"
